package com.astrivix.qr114.tool.permission;
    ...
    private void showToPermissionSettingDialog(final String permission, final Intent intent) {
        ...
        if (notifyDialog == null) {
            notifyDialog = new Jl_Dialog.Builder()
                    ...
                    .content(sb.toString())
                    // --- FIX: Resolve the color resource ID to an actual color integer ---
                    .titleColor(mActivity.getResources().getColor(android.R.color.white))
                    .contentColor(mActivity.getResources().getColor(android.R.color.white))
                    .backgroundColor(mActivity.getResources().getColor(R.color.background_dark))
                    .cancel(false)
                    .left(getString(R.string.cancel))
                    // --- FIX: Use a theme-appropriate color for the button ---
                    .leftColor(mActivity.getResources().getColor(android.R.color.white))
                    .right(getString(R.string.to_setting))
                    // --- FIX: Use a theme-appropriate color for the button ---
                    .rightColor(mActivity.getResources().getColor(R.color.player_green))
    ...
    private void showNotifyGPSDialog() {
        ...
        if (notifyGpsDialog == null) {
            notifyGpsDialog = new Jl_Dialog.Builder()
                    ...
                    // --- FIX: Add colors to match the other dialog ---
                    .titleColor(mActivity.getResources().getColor(android.R.color.white))
                    .contentColor(mActivity.getResources().getColor(android.R.color.white))
                    .backgroundColor(mActivity.getResources().getColor(R.color.background_dark))
                    .cancel(false)
