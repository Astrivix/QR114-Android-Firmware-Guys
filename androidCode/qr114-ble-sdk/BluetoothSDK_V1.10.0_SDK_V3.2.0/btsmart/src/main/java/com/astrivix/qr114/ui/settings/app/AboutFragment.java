...
import com.astrivix.qr114.data.adapter.CommonListAdapter;
import com.astrivix.qr114.data.model.settings.SettingsItem;
import com.astrivix.qr114.ui.CommonActivity;
import com.astrivix.qr114.ui.test.TestConfigurationActivity;
            ...
            adapter.setOnItemClickListener((adapter, view, position) -> {
                ...
                if (getString(R.string.privacy_policy).equals(name)) {
                    ...
                    toWebFragment(0);
                            ...
                            ToastUtil.showToastShort( "Developed by Astrivix");
...
//                    }
    ...
    private String getAppVersion() {
        ...
        try {
            return "V " + packageManager.getPackageInfo(application.getPackageName(), 0).versionName;
