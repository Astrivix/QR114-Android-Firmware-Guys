...
class MusicPlayControlImpl implements PlayControl {
    ...
    public MusicPlayControlImpl() {
        ...
        if (mRCSPController.isDeviceConnected()) {
            Log.i("sasaMsg", "mRCSPController.getDeviceMusicInfo(mRCSPController.getUsingDevice(), null);");
...
//                }
    ...
    private final FileObserver fileObserver = new FileObserver() {
        ...
        public void onFileReceiver(List<FileStruct> fileStructs) {
            Log.i("sasaMsg", "onFileReceiveronFileReceiveronFileReceiveronFileReceiveronFileReceiveronFileReceiveronFileReceiveronFileReceiveronFileReceiveronFileReceiver");
        }

        @Override
        public void onFileReadStop(boolean isEnd) {
            Log.i("sasaMsg", "onFileReadStoponFileReadStoponFileReadStoponFileReadStoponFileReadStoponFileReadStoponFileReadStoponFileReadStoponFileReadStop");
        }

        @Override
        public void onFileReadStart() {
            Log.i("sasaMsg", "onFileReadStartonFileReadStartonFileReadStartonFileReadStartonFileReadStartonFileReadStartonFileReadStartonFileReadStartonFileReadStart");

        }

        @Override
        public void onFileReadFailed(int reason) {
            Log.i("sasaMsg", "onFileReadFailedonFileReadFailedonFileReadFailedonFileReadFailedonFileReadFailedonFileReadFailedonFileReadFailedonFileReadFailed");

        }

        @Override
        public void onSdCardStatusChange(List<SDCardBean> onLineCards) {
            Log.i("sasaMsg", "onSdCardStatusChangeonSdCardStatusChangeonSdCardStatusChangeonSdCardStatusChangeonSdCardStatusChangeonSdCardStatusChangeonSdCardStatusChange");
        ...
        public void OnFlayCallback(boolean success) {
            ...
            Log.i("sasaMsg", "OnFlayCallbackOnFlayCallbackOnFlayCallbackOnFlayCallbackOnFlayCallbackOnFlayCallbackOnFlayCallback");
