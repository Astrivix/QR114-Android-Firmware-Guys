package com.astrivix.qr114.ui.widget.product_dialog;
...
public class FloatingViewService extends Service {
    ...
    private void createNotification() {
        String CHANNEL_ONE_ID = "com.astrivix.qr114";
    ...
    private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (view != null) {
                ...
                if(id == R.id.product_message_close){
                    JL_Log.w(TAG, "click :: dismiss.");
                    dismissWindow(true);
                    return;
                }else if(id == R.id.product_message_connect_btn){
                    callbackConnect(mScanDevice, mBleScanMessage);
                    return;
                }else if(id == R.id.product_message_check_tv){
                    callbackSettings(mScanDevice, mBleScanMessage);
                    return;
                }else if(id == R.id.product_message_finish_tv){
