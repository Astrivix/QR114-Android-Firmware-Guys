...
import com.astrivix.qr114.ui.device.DeviceConnectPresenterImpl;
...
//        super.dismiss();
    ...
    public void onDiscovery(int state, @Nullable BluetoothDevice device, @Nullable BleScanMessage bleScanMessage) {
        Log.i("sasa","onDiscovery - scan device getScanBtDevice scan device dilaog.java" + device + " bleScanMessage " + bleScanMessage);
        switch (state) {
...
//                updateLoadingView(false);
    ...
    private void updateScanDeviceList(ScanBtDevice device) {
        ...
        list.add(device);
        Log.i("sasa","scan device list updateScanDeviceList line number 231" + device);
    ...
    private void updateScanDeviceList(List<ScanBtDevice> list, boolean isAppend) {
        ...
        Log.i("sasa","updateScanDeviceList===" + list );
    ...
    private ScanBtDevice getScanBtDevice(BluetoothDevice device, BleScanMessage scanMessage) {
        ...
        //sasa check device address == the store address
//        if(!device.getAddress().equals("AA:BB:CC:DD:EE")){
//            return null;
//        }
//
