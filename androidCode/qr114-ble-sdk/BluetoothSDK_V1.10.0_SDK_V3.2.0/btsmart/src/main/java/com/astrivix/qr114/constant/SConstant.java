package com.astrivix.qr114.constant;
...
public class SConstant {
    ...
    public static final String URL_PRIVACY_POLICY = "https://qr114.com/privacy-policy";
    // IMPORTANT: Create and add the real URL for your user agreement here
    public static final String URL_USER_AGREEMENT = "https://qr114.com/user-agreement";
    public static final String DEVICE_INSTRUCTION = "https://qr114.com/#assembly";
    ...
    //action
    public final static String ACTION_ACTIVITY_RESUME = "com.astrivix.qr114.activity_resume";
    public final static String ACTION_FAST_CONNECT = "com.astrivix.qr114.fast_connect";
    public final static String ACTION_DEVICE_UPGRADE = "com.astrivix.qr114.device_upgrade";
    public final static String ACTION_ACTIVE_DEVICE_CHANGED = "android.bluetooth.a2dp.profile.action.ACTIVE_DEVICE_CHANGED";
    public final static String ACTION_ADD_DEVICE = "com.astrivix.qr114.add_device";
    public final static String ACTION_DEVICE_UPGRADE_RESULT = "com.astrivix.qr114.device_upgrade_result";
    public final static String ACTION_DEVICE_CONNECTION_CHANGE = "com.astrivix.qr114.device_connection_change";
