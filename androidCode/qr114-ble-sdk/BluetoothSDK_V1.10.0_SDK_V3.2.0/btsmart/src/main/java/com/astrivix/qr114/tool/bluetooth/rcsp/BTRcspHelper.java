package com.astrivix.qr114.tool.bluetooth.rcsp;
...
public class BTRcspHelper {
    ...
    /**
     * Connect devices by broadcasting messages
     *
     * @param controller     控制器
     * @param context        上下文
     * @param device         待连接的设备
        ...
        if (bleScanMessage != null) {
            if (bleScanMessage.getDeviceType() == JL_DeviceType.JL_DEVICE_TYPE_TWS_HEADSET_V1
                ...
                if (edrDevice != null && !isEdrConnect) {
                    /*if (bleScanMessage.getAction() == StateCode.TWS_HEADSET_STATUS_CONNECTED) { //Classic Bluetooth is connected to other phones
