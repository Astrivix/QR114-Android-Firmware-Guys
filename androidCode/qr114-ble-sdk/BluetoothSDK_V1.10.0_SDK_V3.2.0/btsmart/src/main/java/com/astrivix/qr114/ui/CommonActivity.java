...
import com.astrivix.qr114.ui.home.ProfileFragment;
...
public class CommonActivity extends BaseActivity {
    ...
    public static void startCommonActivity(ProfileFragment profileFragment, String canonicalName) {
        if (profileFragment == null || profileFragment.isDetached()) return;
        Intent intent = new Intent(profileFragment.getContext(), CommonActivity.class);
        intent.putExtra(SConstant.KEY_FRAGMENT_TAG, canonicalName);
